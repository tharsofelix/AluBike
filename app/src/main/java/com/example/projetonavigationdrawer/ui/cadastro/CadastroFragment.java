...
public class CadastroFragment extends Fragment {
    ...
    public static final String BANDEIRA = "BANDEIRA DO CARTÃO";
    public static final String NUMEROCARTAO = "NÚMERO CARTÃO";
    public static final String NOMETITULAR = "NOME DO TITULAR";
    public static final String DATAVALIDADE = "DATA DE VALIDADE";
